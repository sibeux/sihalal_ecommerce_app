...
import 'package:sihalal_ecommerce_app/widgets/account_widgets/edit_profile_widgets/confirm_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
              ...
              Obx(
                () => AbsorbPointer(
                  absorbing: editProfileController.getIsNameNotValid() ||
                      editProfileController.name.value.trim().isEmpty ||
                      (editProfileController.name.value.toLowerCase() ==
                              name.toLowerCase() &&
                          !editProfileController.isImageChanged.value) ||
        ...
        Obx(
          () => editProfileController.isSendingDataLoading.value
              ? const Opacity(
                  opacity: 0.8,
