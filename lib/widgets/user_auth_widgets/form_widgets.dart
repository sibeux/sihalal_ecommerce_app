    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: outlineInputBorder(authController),
          focusedBorder: outlineInputBorder(authController),
        ),
      ),
    );
  }
...
OutlineInputBorder outlineInputBorder(dynamic authController) {
  return OutlineInputBorder(
    borderSide: BorderSide(
      color: authController.getTextValue.isNotEmpty
